/**
    ...
    @brief Global DEFINE macros/constants for SATLLA0.

    This file contains the global definition for some macros and constants of the SATLLA0.
...
#define SECS_35 35 * SEC_1
#define SECS_45 45 * SEC_1
#define SECS_50 50 * SEC_1
#define SECS_55 55 * SEC_1
#define MINUTE_1 60 * SEC_1
...
#define CMD_RST_IMU 0x03       // Reset MPU
...
/* Technical Commands */
#define RPI_CMD_SHUT_DOWN 8 // 8 Turn off the RPI

/* ============ */
/* Main LED     */
/* ============ */
// #define MAIN_LED_PIN 29
#define MAIN_LED_BLINK_1HZ 500
#define MAIN_LED_CYCLE_1HZ_30S 60
#define MAIN_LED_BLINK_10HZ 50
#define MAIN_LED_CYCLE_10HZ_30S 600
#define MAIN_LED_BLINK_100HZ 5
#define MAIN_LED_CYCLE_100HZ_30S 6000
#define MAIN_LED_BLINK_9600HZ 104      // us
#define MAIN_LED_CYCLE_9600HZ_6S 60000 // 6 sec

/* ============ */
/* LAISER     */
/* ============ */

// #define FAT_LASER_PIN 26
#define MAIN_LASER_BLINK_1HZ 500
#define MAIN_LASER_CYCLE_1HZ_30S 60
#define MAIN_LASER_CYCLE_1HZ_5S 10
#define MAIN_LASER_BLINK_10HZ 50
#define MAIN_LASER_CYCLE_10HZ_30S 600
#define MAIN_LASER_CYCLE_10HZ_5S 100
#define MAIN_LASER_BLINK_100HZ 5
#define MAIN_LASER_CYCLE_100HZ_30S 6000
#define MAIN_LASER_CYCLE_100HZ_5S 1000
#define MAIN_LASER_BLINK_9600HZ 104      // us
#define MAIN_LASER_CYCLE_9600HZ_6S 60000 // 6 sec
#define MAIN_LASER_CYCLE_9600HZ_5S 10000 // 6 sec